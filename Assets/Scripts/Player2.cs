...
{
    public float racketSpeed; // determines player 2's racket speed
    ...
    void Update()
    {
        // we're getting the input from player 2 - the input we want is GetAxisRaw
        ...
        float directionY = Input.GetAxisRaw("Vertical2"); // checks if player 2 pressed a button - save this within a float variable
